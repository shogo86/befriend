        ...
        <div class="wrapper clearfix">
            <main class="main">
                ...
                <div class = "profile_picture_edit">
                    ...
                    <p class = "profile_title_edit">プロフィール写真の編集</p>
                    <img src="<?php print $picture_1; ?>" class="thumb" data-image="<?php print $picture_1; ?>">
                    <div class="profile_inputform">
                    <form method="post" action="mypage_profile_picture_done_1.php" enctype="multipart/form-data">
                        <div class="img_input">
                    ...
                    <p class = "profile_title_edit">サブ写真の編集</p>
                    <img src="<?php print $picture_2; ?>" class="thumb" data-image="<?php print $picture_2; ?>">
                    <div class="profile_inputform">
                    <form method="post" action="mypage_profile_picture_done_2.php" enctype="multipart/form-data">
                        <div class="img_input">
                        <input type="file" name="picture_2" required>
                        </div>
                        <input type="submit" value="画像を変更する">
                    </form>
                    </div>
                    <img src="<?php print $picture_3; ?>" class="thumb" data-image="<?php print $picture_3; ?>">
                    <div class="profile_inputform">
                    <form method="post" action="mypage_profile_picture_done_3.php" enctype="multipart/form-data">
                        <div class="img_input">
                        <input type="file" name="picture_3" required>
                        </div>
                        <input type="submit" value="画像を変更する">
                    </form>
                    </div>
                    <img src="<?php print $picture_4; ?>" class="thumb" data-image="<?php print $picture_4; ?>">
                    <div class="profile_inputform">
                    <form method="post" action="mypage_profile_picture_done_4.php" enctype="multipart/form-data">
                        <div class="img_input">
                        <input type="file" name="picture_4" required>
                        </div>
                        <input type="submit" value="画像を変更する">
                    </form> 
                    </div>
