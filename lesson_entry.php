    ...
    <body>
        ...
        <section class="contact" id="contact">
            ...
            <form class="contact-form" method="post" action="lesson_entry_done.php">
                ...
                <input type="text" name="street" placeholder="詳細住所を入力してください。" required class="street">
                <textarea name="detail" rows="5" cols="40" placeholder="詳細の記入をしてください" class="detail"></textarea>
                </div>
                <input type="submit" value="上記の内容で登録する" class="send">
            </form>
        </section>
        <footer class="footer">
