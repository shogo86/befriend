        ...
        <div class="wrapper clearfix">
            <main class="main">
                ...
                <div class = "profile_picture">
                    <a href = "" class = "profile_edit">写真編集</a>
                    <div>
                ...
                print '<div class = "profile_text_edit">';
                print '<p class = "profile_title">プロフィールを更新する</p>';
                print '<form action = "mypage_profile_confirm.php" method = "post">';
                print '<p class = "desc">メールアドレス</p>';
                print '<input type = "text"  name = "email" value = '.$email.' class="input_form" >';
                ...
                print '<input type = "number"  name = "age"　min="18" max="100"　step="1" value = '.$age.' >';
                ...
                print '<select name="sub_language" value='.$sub_language.'>';
                print '<option value="1">日本語</option>';
                print '<option value="2">英語</option>';
                print '<option value="3">中国語</option>';
                print '</select>';
                ...
                print '<p class = "desc">職業</p>';
                print '<input type = "text"  name = "works" value = '.$works.' >';
                ...
                /*
                    print '<p class = "desc">email　　　 　　　　'.'<a href = "profile_edit.php?fb_user_id='.$fb_user_id.'">'.$email.'</a></p>';
